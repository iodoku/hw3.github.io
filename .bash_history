...
git branch -M main
git push -u origin main
git config --global user.name "iodoku"
git config --global user.email "jdhi0112@naver.com"
git config --list
git add .
git commit -m "Initial commit"
git push -u origin main
...
python app.py
sudo ufw allow 13048
sudo ufw allow 3306
sudo ufw reload
python app.py
CREATE USER 'jdh'@'localhost' IDENTIFIED BY '1234';
mysql --version
...
sudo systemctl restart mysql
mysql -u root -p
mysql -u jdh -p -h 113.198.66.75
sudo nano /etc/mysql/mysql.conf.d/mysqld.cnf
sudo systemctl restart mysql
mysql -u jdh -p -h 113.198.66.75 -P 3000
mysql -u jdh -p -h 113.198.66.75 -P 13048
mysql -u jdh -p -h localhost -P 13048
sudo nano /etc/mysql/mysql.conf.d/mysqld.cnf
sudo systemctl restart mysql
...
mysql -u jdh -p -h 113.198.66.75 -P 3000
mysql -u jdh -p -h 113.198.66.75 -P 13048
mysql -u jdh -p 1234 -h 113.198.66.75 -P 13048
mysql -u jdh -p -h 10.0.0.48 -P 3306
curl ifconfig.me
hostname -I
sudo netstat -tlnp
sudo netstat -tlnp | grep mysql
sudo nano /etc/mysql/mysql.conf.d/mysqld.cnf
mysql -u jdh -h 113.198.66.75 -P 13048
mysql -u jdh -p -h 113.198.66.75 -P 13048
sudo netstat -tlnp | grep mysql
sudo nano /etc/mysql/mysql.conf.d/mysqld.cnf
sudo systemctl restart mysql
